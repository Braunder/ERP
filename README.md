...
| `SYNC_SCHEDULE`        | Расписание синхронизации в формате cron                             | `0 * * * *`                                            |
...
### Формат выгружаемых листов

Синхронизация формирует два листа в Google Таблице:

- лист **"Отчет"** в формате P&L (доходы/расходы/прибыль) по месяцам;
- лист **"Операции"** с выгрузкой всех операций из базы: дата, тип, категория, сумма, комментарий, способ оплаты, поставщик, сотрудник и т.д.
